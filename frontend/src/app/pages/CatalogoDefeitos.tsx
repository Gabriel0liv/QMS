...
export function CatalogoDefeitos() {
    return (
        <div className="min-h-screen bg-slate-50 p-6 lg:p-10">
            <div className="mb-8 flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Catálogo de Defeitos</h1>
                    <p className="text-sm text-gray-500">Criar, editar e inativar defeitos</p>
                </div>
            </div>
