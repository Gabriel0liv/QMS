    ...
    return (
        <div className="min-h-screen bg-slate-50 p-6 lg:p-10">
            <div className="mb-8 flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Retrabalho</h1>
                    <p className="text-sm text-gray-500">Registo de ações, tempos e máquinas</p>
                </div>
            </div>
